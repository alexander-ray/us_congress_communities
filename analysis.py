...
#         '''
#         if chamber == 'house':
#             G_bipartite = generate_bipartite_graph('/home/eitri/git/us_congress_communities/data/', congress, house_names)
#         else:
#             G_bipartite = generate_bipartite_graph('/home/eitri/git/us_congress_communities/data/', congress, senate_names)
